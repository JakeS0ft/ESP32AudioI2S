...
bool I2SWavPlayer::ContinuePlayback()
{
	...
	//TODO: Add ESP32 specific code
		...
		if (mBufferASelected == true)
		{
			...
			I2SPlayI2SWrite(maBufferA, sizeof(int32_t)*I2S_BUF_SIZE);
		}
		else
		{
			memcpy(maBufferB, maMixedI2SSamples, sizeof(int32_t)*I2S_BUF_SIZE);
			I2SPlayI2SWrite(maBufferB, sizeof(int32_t)*I2S_BUF_SIZE);
		}
...
void I2SWavPlayer::Configure_I2S_Speed(ESampleRate aSampleRate)
{
	mSampleRate = aSampleRate;

	//TODO: Update with ESP32 code
...
{
	I2SPlayConfigI2S(mPinMCK,
			         mPinBCLK,
					 mPinLRCK,
					 mPinDIN,
					 sizeof(int32_t)*I2S_BUF_SIZE);
