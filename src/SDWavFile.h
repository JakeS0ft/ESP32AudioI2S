...
public:
   ...
   /**
    * Sets pause ramping on or off
    * Args:
    *  aUseRamping - TRUE=Ramp FALSE=Don't ramp
    */
   virtual void SetPauseRamping(bool aUseRamping);
protected:
   ...
   //Keep track of pause ramping controls
   bool mIsPauseRampingEnabled;

   //Number of samples remaining to ramp down before full pause
   int mPauseRampDownSamplesLeft;
   //Number of samples remaining to ramp up after unpause before full volume
   int mPauseRampUpSamplesLeft;
