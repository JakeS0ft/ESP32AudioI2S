...
//I2S buffer size
//32-bits per sample = 4 bytes per sample,
//so 4 * 256 = the ESP32 max DMA buffer size of 1024
...
#define PIN_I2S_BCLK_DEFAULT (14)
...
public:
	 ...
	 *                ee4410 = 44.1 KHz
	 */
	void Configure_I2S_Speed(ESampleRate aSampleRate);
